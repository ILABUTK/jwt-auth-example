...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Logout")])]) : _vm._e(), _vm._v(" "), (_vm.auth.authenticated) ? _c('li', {
    staticClass: "pull-right"
  }, [_vm._v("\n              Hi, " + _vm._s(_vm.auth.user.name) + "\n          ")]) : _vm._e()])]), _vm._v(" "), _c('h3', [_vm._v("Tasks List")]), _vm._v(" "), _c('ul', {
  ...
  })), _vm._v(" "), (_vm.auth.authenticated) ? _c('router-link', {
    attrs: {
      "to": "/create"
    }
  }, [_vm._v("Create a new task")]) : _vm._e()], 1)
},staticRenderFns: []}
